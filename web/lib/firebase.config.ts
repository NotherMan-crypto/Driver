...
// Tạm thời sử dụng các key rỗng, người dùng cần điền vào file .env.local
...
// Bắt buộc dùng Long Polling để sửa lỗi "client is offline" trên Next.js (bị drop WebSocket)
